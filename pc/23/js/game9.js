$(function () {
  ...
  $('.playGame img').on("mousedown", function () {
    if (count >= 1) {
      $(this).attr("src","img/game-startbtnh.png");
    }  
  });

  $('.playGame img').on("touchstart", function () {
    if (count >= 1) {
      $(this).attr("src","img/game-startbtnh.png");
    }  
  });

  $('.playGame img').on("mouseup", function () {
    if (count >= 1) {
      $(this).attr("src","img/game-startbtn.png");
    }  
  });

  $('.playGame img').on("touchend", function () {
    if (count >= 1) {
      $(this).attr("src","img/game-startbtn.png");
    }  
  });
